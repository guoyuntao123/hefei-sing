...
<<<<<<< HEAD
    <div class="singerDesc">
      <div class="singerDesc-left">
        <h1 class="singer-title">
          {{singerId}}
        </h1>
        <div class="singer-desc">
          {{introduction}}
        </div>
       <div class="all-songs"></div>
      </div>
      <div class="hotSinger-right">
        13
      </div>
=======
    <div class="content">
      歌手详情{{singerId}}
>>>>>>> 7776bc74b6b64012c36206935f61dd5a7e53a49c
    </div>
    <Bottom></Bottom>
  </div>
</template>
...
<style scoped>
<<<<<<< HEAD
.singer-title{text-align: center;
color:#D56464}
  .singerDesc-left{
    width: 800px;
    line-height: 32px;
